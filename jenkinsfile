    ...
    stages {
        stage('Build') {
            steps {
                ...
                git 'https://github.com/Teja-mummidi/star-agile-banking-finance.git'
       ...
       stage('Create Docker Image') {
           steps {
               sh 'docker build -t tejamummidi005/banking-project-demo:1.0 .'
                    }
                }
       stage('Docker-Login') {
           steps {
       ...
       stage('Push-Image') {
           steps {
               sh 'docker push tejamummidi005/banking-project-demo:1.0'
                     }
                }
